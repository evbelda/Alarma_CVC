...
//LectorSD::LectorSD(int pinSelect, RelojAlarma *reloj)
...
//void LectorSD::iniciaSD(int pinSelect, RelojAlarma *reloj)
void LectorSD::iniciaSD(int pinSelect, RelojAlarma *reloj, AlarmaC *alcObj)
{
	pinMode(pinSelect, OUTPUT);
	if (!SD.begin(chipSelect)) {
		Serial.println("initialization failed!");
...
//void LectorSD::leerTarjeta(int tipo, RelojAlarma *reloj) {
